...
public class StudentSectionPersistenceStub implements StudentSectionPersistence {
    ...
    public StudentSectionPersistenceStub() {
        ...
        Section comp3350 = new Section("COMP 3350 - A01", "Dr. Heather Matheson", new String[]{"Monday", " Wednesday", " Friday"}, "9:30 AM - 10:20 AM", "Remote", 10, 500, "COMP 3350", "Computer Science");
        Section biol1300 = new Section("BIOL 1300 - A01", "Micolash", new String[]{"Tuesday", " Thursday"}, " 11:30 AM - 12:45 PM", "Remote", 10, 200, "BIOL 1300", "Biological Sciences");
        Section math1500 = new Section("MATH 1500 - A01", "Eilo", new String[]{"Monday", " Wednesday", " Friday"}, "11:30 AM - 12:20 PM", "Remote", 5, 200, "MATH 1500", "Mathematics");
        Section math1500Lab = new Section("MATH 1500 - B04", "Wallar", new String[]{"Tuesday"}, "2:30 PM - 3:45 PM", "Remote", 2, 40, "MATH 1500", "Mathematics");
        Section engl1400 = new Section("ENGL 1400 - A04", "Galhad", new String[]{"Monday", " Wednesday", " Friday"}, " 10:30 AM - 11:20 AM", "Remote", 3, 40, "ENGL 1400", "English");
        Section chem1110 = new Section("CHEM 1110 - A02", "Gehrman", new String[]{"Tuesday", " Thursday"},  " 8:30 AM - 9:45 AM", "Remote", 3, 221, "CHEM 1110", "Chemistry");
        Section math1300 = new Section("MATH 1300 - A02", "Wallar", new String[]{"Monday", " Wednesday", " Friday"}, " 9:30 AM - 10:20 AM", "Remote", 5, 175, "MATH 1300", "Mathematics");
        Section comp1012 = new Section("COMP 1012 - B01", "Siegward", new String[]{"Wednesday"}, "8:30 AM - 9:20 AM", "Remote", 2, 16, "COMP 1012", "Computer Science");
        Section biol1010 = new Section("BIOL 1010 - A01", "Gascoigne", new String[]{"Monday", " Wednesday", " Friday"}, " 10:30 AM - 11:20 AM", "Remote", 10, 198, "BIOL 1010", "Biological Sciences");

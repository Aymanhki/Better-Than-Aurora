...
public class ViewGPATest {
    ...
    public void viewGpaTest()
    {
        ...
        onView(withId(R.id.gpa_history_text)).check(matches(withText(containsString("4.5"))));
        ...
        onView(withId(R.id.student_courses)).perform(click());
        onView(withId(R.id.history_btn)).perform(click());
        onView(withId(R.id.gpa_history_text)).check(matches(withText(containsString("0.0"))));

        pressBack();

        onView(withId(R.id.student_home)).perform(click());
